...
// imports imgage
import contactInfo from '@/assets/images/about/about-3-e1676065375680.webp';
import { BsIntersect } from 'react-icons/bs';
import CountUp from 'react-countup';
export default function FlagLang({ isOdd, data }) {
      ...
      <div className="py-[1rem] sm:py-[4rem]  px-4 2xl:pl-[8rem] md:pl-[4rem] md:pr-8">
        ...
        {/* {info.map((item, index) => (
          <div key={index} className="flex justify-start items-center my-8">
            <div className="w-40 h-12 px-5 flex items-center bg-black text-white dark:bg-[#EAE9FB] dark:text-black">
              {item.key}
            </div>
